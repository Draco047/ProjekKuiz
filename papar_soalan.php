...
<body>
	...
	<main>
		<table width="70%" border="0" align="center" style='font-size:16px'>
			...
			<?php
			$no = 1;
			$data1 = mysqli_query($hubung, "SELECT * FROM soalan AS q INNER JOIN pilihan AS a ON q.idsoalan = a.idsoalan WHERE q.idtopik=$topik_pilihan AND a.idtopik=$topik_pilihan GROUP BY a.idsoalan ORDER BY q.idsoalan ASC");
			...
			?>
				<tr>
					...
					<td><a href="edit_soalan.php?idsoalan= <?php echo $info1['idsoalan']; ?>"><button>EDIT</button></a>
						<a href="hapus_soalan.php?idsoalan=<?php echo $info1['idsoalan']; ?>"><button>HAPUS</button></a></td>
				</tr>

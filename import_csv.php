...
if(!isset($tambah)){
echo "<script type=\"text/javascript\">alert(\"Pindah naik 
fail CSV gagal\");
window.location = \"import_daftar.php\"</script>";
}
//MSG POP UP JIKA BERJAYA
else {
echo "<script table=\"text/javascript\">alert(\"Pindah naik 
fail CSV berjaya\");
window.location = \"pelajar_senarai.php\"
</script>";
}
}
			fclose($file);
